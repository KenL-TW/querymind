/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false ./src/worker-configuration.d.ts` (hash: d5b16b0a834fae8851da6c3fa9ee9ca4)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	QUERYMIND_DATA: D1Database;
	QUERYMIND_APP: D1Database;
	ASSETS: Fetcher;
	ENVIRONMENT: string;
	OPENAI_MODEL: string;
	ALLOWED_OPENAI_MODELS: string;
	AI_GATEWAY_URL: string;
	AI_GATEWAY_BYOK_ALIAS: string;
	AI_MOCK_MODE: string;
	AI_USER_REQUESTS_PER_HOUR: string;
	AI_GLOBAL_REQUESTS_PER_DAY: string;
	AI_MAX_PROMPT_CHARACTERS: string;
	SEMANTIC_RUNTIME_CONTEXT_ENABLED: string;
	AUTH_REQUIRED: string;
	AUTH_TOKEN_TTL_SECONDS: string;
	AUTH_LOGIN_ATTEMPTS_PER_15_MINUTES: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "OPENAI_MODEL" | "ALLOWED_OPENAI_MODELS" | "AI_GATEWAY_URL" | "AI_GATEWAY_BYOK_ALIAS" | "AI_MOCK_MODE" | "AI_USER_REQUESTS_PER_HOUR" | "AI_GLOBAL_REQUESTS_PER_DAY" | "AI_MAX_PROMPT_CHARACTERS" | "SEMANTIC_RUNTIME_CONTEXT_ENABLED" | "AUTH_REQUIRED" | "AUTH_TOKEN_TTL_SECONDS" | "AUTH_LOGIN_ATTEMPTS_PER_15_MINUTES" | "AUTH_JWT_SECRET" | "AUTH_BOOTSTRAP_TOKEN" | "AUTH_PASSWORD_PEPPER" | "AI_GATEWAY_TOKEN">> {}
}
